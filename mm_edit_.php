...
if (isset($_POST['delRec']) && ($_POST['delRec'] != "")) {  
  ...
  <div id="main_body">
    <div id="content" class="clear clearfix">
      <div class="media">
        ...
        <form action="mm_edit_2.php" method="post" name="form4" id="form4">
          <table align="center">
            <tr valign="baseline">
            ...
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Date:</td>
              <td><input type="text" name="Date2" value="<?php echo htmlentities($row_updateRec['Date'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Message:</td>
              <td><input type="text" name="Message2" value="<?php echo htmlentities($row_updateRec['Message'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Speaker:</td>
              <td><input type="text" name="Speaker2" value="<?php echo htmlentities($row_updateRec['Speaker'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Media:</td>
              <td><input type="text" name="Media2" value="<?php echo htmlentities($row_updateRec['Media'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">&nbsp;</td>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <?php do { ?>
            <tr>
              ...
              <td><form id="form2" name="form2" method="post" action="mm_edit_.php">
              ...
              <td><form id="form3" name="form3" method="post" action="mm_edit_.php">
